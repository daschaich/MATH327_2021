...
\begin{center}
  \includegraphics[width=0.45\textwidth]{figs/diff_zero.pdf}
\end{center}
...
However, as time goes on, there is a steady decrease in the probability that any given walker will end up at its starting point $x = 0$.\footnote{As in \secref{sec:CLT}, we can extract this probability by integrating the distribution $p(x)$ over the interval $[-0.5, 0.5]$.}
