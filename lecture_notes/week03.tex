...
\begin{shaded}
  ...
  \end{equation}
%  A \textbf{fluctuation--dissipation relation} guarantees that the heat capacity is always non-negative (and generically positive):
%  \begin{equation}
%    \label{eq:fluct_diss}
%    c_v = \frac{1}{T^2}\vev{\left(E - \vev{E}\right)^2} \geq 0.
%  \end{equation}
\end{shaded}
